...
assert.match(read('public/js/saas-subscription-admin-ui.js'), /Sin fecha registrada/);
assert.match(read('public/js/saas-subscription-admin-ui.js'), /timeZone: 'America\/La_Paz'/);
assert.match(read('public/js/subscription-ui.js'), /Sin fecha registrada/);
