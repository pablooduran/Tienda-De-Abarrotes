  ...
  function create(deps) {
    ...
    function customerActions(customer) {
      if (!customer.activo) return `<div class="actions customer-actions">
        ...
        <details class="row-actions"><summary>Más opciones</summary><button type="button" class="small secondary" data-customer-statement="${customer.idCliente}">Estado de cuenta</button>${!readOnly() ? `<button type="button" class="small" data-customer-restore="${customer.idCliente}">Restaurar cliente</button>` : ''}<button type="button" class="small secondary secondary-actions-close" data-secondary-actions-close>Cerrar</button></details>
      </div>`;
