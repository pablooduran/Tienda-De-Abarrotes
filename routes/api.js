...
router.get('/contexto', (req, res) => {
  ...
  res.json({
    ...
    suscripcion: context.suscripcion ? {
      tipo: context.suscripcion.tipo,
      estado: context.suscripcion.estado,
      estadoEfectivo: context.suscripcion.estadoEfectivo,
      fechaInicio: context.suscripcion.fechaInicio,
      fechaFin: context.suscripcion.fechaFin,
      fechaFinGracia: context.suscripcion.fechaFinGracia,
      diasRestantes: context.suscripcion.diasRestantes,
      diasGraciaRestantes: context.suscripcion.diasGraciaRestantes,
      tipoPeriodo: context.suscripcion.tipoPeriodo
    } : null,
    acceso: context.acceso,
    estadoAcceso: context.estadoAcceso,
