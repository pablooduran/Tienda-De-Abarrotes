...
| 3. Modales, filtros y acciones | Suscripciones SaaS, Pagos de suscripción y Tiendas usan Filtros → Aplicar → cerrar; cerrar sin aplicar no modifica resultados. En Tiendas la búsqueda principal permanece visible. En Pagos se conserva la lista anterior si falla la carga. | Llevar la convención a Catálogo, Auditoría y módulos del propietario; conservar búsquedas principales de POS y Compras. |
