...
| 3. Modales, filtros y acciones | Suscripciones SaaS, Pagos, Tiendas y Catálogo maestro usan Filtros → Aplicar → cerrar; cerrar sin aplicar no modifica resultados. Las búsquedas principales de Tiendas y Catálogo permanecen visibles. En Pagos y Catálogo se conserva la lista anterior si falla la carga. | Llevar la convención a Auditoría y módulos del propietario; conservar búsquedas principales de POS y Compras. |
