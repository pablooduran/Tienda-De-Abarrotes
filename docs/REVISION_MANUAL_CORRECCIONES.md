...
| 3. Modales, filtros y acciones | Hay patrones compartidos y varios filtros compactos. Suscripciones SaaS inicia la convención Filtros → Aplicar → cerrar; cerrar sin aplicar no modifica resultados. | Llevar la convención a Pagos, Tiendas, Catálogo, Auditoría y módulos del propietario; conservar búsquedas principales de POS y Compras. |
