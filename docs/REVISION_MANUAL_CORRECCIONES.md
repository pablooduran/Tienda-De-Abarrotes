...
| 2. Navegación y arquitectura | Familias del propietario y vistas independientes implementadas. Este bloque cierra acordeón exclusivo, acceso directo para Inicio/Clientes/Mi plan y vistas independientes de superadmin. | Revisar pestañas internas duplicadas y detalle de tienda/suscripción que desplaza la página. |
...
1. Cerrar pendientes de navegación: pestañas duplicadas y detalles que hacen perder contexto.
