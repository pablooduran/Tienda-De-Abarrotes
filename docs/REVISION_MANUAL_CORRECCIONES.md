...
| 3. Modales, filtros y acciones | Suscripciones SaaS y Pagos de suscripción usan Filtros → Aplicar → cerrar; cerrar sin aplicar no modifica resultados. En Pagos se conserva la lista anterior si falla la carga. | Llevar la convención a Tiendas, Catálogo, Auditoría y módulos del propietario; conservar búsquedas principales de POS y Compras. |
