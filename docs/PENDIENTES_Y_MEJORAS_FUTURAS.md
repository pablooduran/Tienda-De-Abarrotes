...
| TECH-028 | Product Analytics | PRODUCT-GROWTH necesita medir uso sin acoplar la aplicacion a un proveedor | alta antes de beta | adaptador desacoplado, eventos, funnels, activacion, retencion, privacidad y proveedor desactivable/no-op local | No | Parcialmente implementado: contrato, allowlist, noop, hechos de activacion, venta a credito, cobranza, solicitud de pago y UX de plan/cotizacion; `product_created`, `customer_created`, proveedor y control operativo siguen pendientes | PRODUCT-GROWTH-0A / 0C1 / 0C2 |
