...
| TECH-028 | Product Analytics | PRODUCT-GROWTH necesita medir uso sin acoplar la aplicacion a un proveedor | alta antes de beta | adaptador desacoplado, eventos, funnels, activacion, retencion, privacidad y proveedor desactivable/no-op local | No | PRODUCT-GROWTH-0 cerrado en alcance local/desacoplado: contrato, allowlist, noop, hechos de activacion, venta a credito, cobranza, solicitud de pago y UX de plan/cotizacion. Medicion remota, proveedor y control operativo siguen pendientes; el CI remoto reciente no es visible desde el conector | PRODUCT-GROWTH-0 / antes de piloto |
