...
const BASE_AUDIT_ACTIONS = {
  ...
  upgrade_suscripcion: definition('suscripcion', 'suscripcion', ['planCodigo'], ['planCodigo']),
  downgrade_suscripcion_programado: definition('suscripcion', 'suscripcion', ['planCodigo'], ['planCodigo']),
  ...
  registro_tipo_cambio_suscripcion: definition(
    'pago_suscripcion', 'tipo_cambio_suscripcion', [], [], ['monedaOrigen', 'monedaDestino']
  ),
  configuracion_metodo_pago_suscripcion: definition(
    'pago_suscripcion', 'metodo_pago_suscripcion', ['activo'], ['activo'], ['metodoPago']
  ),
  creacion_solicitud_pago_suscripcion: definition(
    'pago_suscripcion', 'solicitud_pago_suscripcion', [], ['estado'],
    ['tipoOperacion', 'planCodigo', 'periodo', 'metodoPago']
  ),
  ...
  revision_solicitud_pago_suscripcion: definition(
    'pago_suscripcion', 'revision_solicitud_pago_suscripcion', ['estado'], ['estado'], ['motivoCodigo']
  ),
  aplicacion_pago_suscripcion: definition(
    'pago_suscripcion', 'solicitud_pago_suscripcion', ['estado'], ['estado'],
    ['tipoOperacion', 'planCodigo', 'periodo']
  )
};
...
const BASE_ACTION_RESULT_CODES = {
  ...
  upgrade_suscripcion: Object.freeze(['SUBSCRIPTION_PLAN_UPGRADED']),
  downgrade_suscripcion_programado: Object.freeze(['SUBSCRIPTION_DOWNGRADE_SCHEDULED']),
  ...
  revision_solicitud_pago_suscripcion: Object.freeze(['PAYMENT_REQUEST_OBSERVED', 'PAYMENT_REQUEST_REJECTED']),
  aplicacion_pago_suscripcion: Object.freeze(['PAYMENT_REQUEST_APPLIED'])
};
...
const AUDIT_RESULT_CODES = Object.freeze([
  ...
  'PAYMENT_EXCHANGE_RATE_REGISTERED',
  'PAYMENT_METHOD_CONFIGURED',
  'PAYMENT_REQUEST_CREATED',
  'PAYMENT_REQUEST_CANCELLED',
  'PAYMENT_RECEIPT_UPLOADED',
  'PAYMENT_REQUEST_OBSERVED',
  'PAYMENT_REQUEST_REJECTED',
  'PAYMENT_REQUEST_APPLIED',
...
const AUDIT_RESULTS_BY_CODE = Object.freeze({
  ...
  SUBSCRIPTION_PLAN_UPGRADED: Object.freeze(['correcto']),
  SUBSCRIPTION_DOWNGRADE_SCHEDULED: Object.freeze(['correcto']),
  ...
  PAYMENT_EXCHANGE_RATE_REGISTERED: Object.freeze(['correcto']),
  ...
  PAYMENT_REQUEST_OBSERVED: Object.freeze(['correcto']),
  PAYMENT_REQUEST_REJECTED: Object.freeze(['correcto']),
  PAYMENT_REQUEST_APPLIED: Object.freeze(['correcto']),
