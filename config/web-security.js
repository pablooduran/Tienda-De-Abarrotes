...
function webSecurityConfig(environment = process.env) {
  ...
  return Object.freeze({
    ...
    rateLimit: Object.freeze({
      ...
      emailVerificationConfirmMax: integerSetting(environment, 'EMAIL_VERIFICATION_CONFIRM_RATE_LIMIT_MAX', 20, 1, 1000),
      emailVerificationResendIpMax: integerSetting(environment, 'EMAIL_VERIFICATION_RESEND_IP_RATE_LIMIT_MAX', 5, 1, 1000),
      emailVerificationResendIdentityMax: integerSetting(environment, 'EMAIL_VERIFICATION_RESEND_IDENTITY_RATE_LIMIT_MAX', 3, 1, 1000),
      passwordRecoveryRequestIpMax: integerSetting(environment, 'PASSWORD_RECOVERY_REQUEST_IP_RATE_LIMIT_MAX', 5, 1, 1000),
      passwordRecoveryRequestIdentityMax: integerSetting(environment, 'PASSWORD_RECOVERY_REQUEST_IDENTITY_RATE_LIMIT_MAX', 3, 1, 1000),
      passwordRecoveryConfirmIpMax: integerSetting(environment, 'PASSWORD_RECOVERY_CONFIRM_IP_RATE_LIMIT_MAX', 20, 1, 1000),
